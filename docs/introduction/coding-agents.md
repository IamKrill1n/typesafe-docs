...
Jev is a [System One model](../concepts/system-one.md). It does not generate text, write code, or hold a conversation. It takes a [state](../concepts/state.md) and a set of typed [questions](../primitives.md) and returns structured answers your code can use directly:
...
If any of that matches what you're building, the fastest path in is the [Quick start](./quickstart.md), then the [primitives](../primitives.md) reference for the question types.

## Next steps

* [System One](../concepts/system-one.md) — What a System One model is and how it differs from an LLM.

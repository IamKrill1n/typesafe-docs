...
These rates describe groups of predictions, not a guarantee about any single answer. See [Confidence](../confidence.md) for guidance on deciding when software should act or escalate.

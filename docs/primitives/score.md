...
> Interactive score explorer — [view it on docs.typesafe.ai](https://docs.typesafe.ai/primitives/score)
...
> Interactive example — [view it on docs.typesafe.ai](https://docs.typesafe.ai/primitives/score)
